...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private static final String JSON_URL = "http://34.93.190.224:8080/admin/users/getByMobileNumber?mobileNumber=";
...
//        }
        ...
        if (TextUtils.isEmpty(email)) {
            ...
            mEmailView.setError(getString(R.string.error_invalid_mobileNumber));
            focusView = mEmailView;
            cancel = true;
        }
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.GET, JSON_URL + mEmail,
                        ...
                        public void onResponse(String response) {
                            ...
                            if (response != null) {
                                try {
                                    ...
                                    String password = heroObject.getString("password");

                                    if (password.equals(mPassword)) {
                                        JSONArray arrObject = heroObject.getJSONArray("role");
                                        Set<String> roles = new LinkedHashSet<>();
                                        for (int i = 0; i < arrObject.length(); i++) {
                                            roles.add(arrObject.getString(i));
                                        }

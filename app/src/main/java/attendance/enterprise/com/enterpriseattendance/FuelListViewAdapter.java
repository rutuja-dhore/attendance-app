...
public class FuelListViewAdapter extends ArrayAdapter<Fuel> {

    //the hero list that will be displayed
    private List<Fuel> heroList;
    ...
    public FuelListViewAdapter(List<Fuel> heroList, Context mCtx) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Fuel hero = heroList.get(position);

        //setting hero values to textviews

        SimpleDateFormat formatter = new SimpleDateFormat("yyyy-MM-dd");
        textViewName.setText(formatter.format(hero.getDate()));
        textViewImageUrl.setText("User : " + hero.getVan().getNumber());
